...
export function SearchPanel({
  ...
  useEffect(() => {
    if (state.kind !== "error" || state.message === "Model not found") return;
  ...
  return (
    <section className="glass panel-card" role="tabpanel">
      ...
      {state.kind === "error" && state.message === "Model not found" &&
        createPortal(
          <div
            role="presentation"
          ...
          >
            ...
            >
              <div className="search-error-header">
                ...
                <h2 id="semantic-search-error-title">
                  Semantic Search unavailable
                </h2>
              </div>
              <p id="semantic-search-error-message">
                {state.message}
              </p>
